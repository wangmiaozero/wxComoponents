    ...
    return new Promise((resolve, reject) => {
      wx.getImageInfo({
        ...
        success: function(res) {
          ...
          context.drawImage(
            res.path,
            deviceWidth * (_this.data.expressData.list.product.x ),
            deviceWidth * (_this.data.expressData.list.product.y ),
            deviceWidth * (_this.data.expressData.list.product.width ),
            deviceWidth * (_this.data.expressData.list.product.height )
          );
          // 文字
